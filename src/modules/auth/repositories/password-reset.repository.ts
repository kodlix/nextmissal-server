...
import { IPasswordResetRepository } from '@modules/auth/repositories/password-reset.repository.interface';
  ...
  implements IPasswordResetRepository
{
  ...
  async findById(id: bigint): Promise<PasswordReset | null> {
  ...
  async findByUserId(userId: bigint): Promise<PasswordReset | null> {
