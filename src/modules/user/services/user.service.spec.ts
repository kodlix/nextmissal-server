...
const createMockDomainEventService = () => ({
...
describe('UserService', () => {
  ...
  beforeEach(async () => {
    ...
    domainEventService = createMockDomainEventService();
  ...
  describe('updateUserDetails', () => {
    ...
    it('should throw EntityNotFoundException for non-existent user', async () => {
      // Arrange
      const userId = BigInt(5000000023);
      const newFirstName = 'Jane';
  ...
  describe('changePassword', () => {
    ...
    it('should throw EntityNotFoundException for non-existent user', async () => {
      // Arrange
      const userId = BigInt(50000000020);
      const newPassword = 'NewPass456!';
